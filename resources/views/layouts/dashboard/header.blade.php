              ...
              <ul class="mega-dropdown-menu dropdown-menu row">
                <li class="col-md-2">
                  ...
                  <div id="mega-menu-carousel-example">
                    <div>
                      <img class="rounded img-fluid mb-1" src="{{asset('assets/dashboard')}}/images/slider/slider-2.png"
  ...
  <li class="dropdown dropdown-language nav-item">
    ...
    @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
           ...
           <i class="flag-icon @if($localeCode == 'en') flag-icon-gb @else flag-icon flag-icon-eg @endif"></i>    {{ $properties['native'] }}
            </a>
    @endforeach
 </div>
            </li>
                ...
                <li class="scrollable-container media-list w-100">
                    ...
                    <div class="media">
                      <div class="media-left">
                        <span class="avatar avatar-sm avatar-busy rounded-circle">
                          <img src="{{asset('assets/dashboard')}}/images/portrait/small/avatar-s-2.png" alt="avatar"><i></i></span>
                      </div>
                      <div class="media-body">
                  ...
                  <a href="javascript:void(0)">
                    <div class="media">
                      <div class="media-left">
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="{{asset('assets/dashboard')}}/images/portrait/small/avatar-s-3.png" alt="avatar"><i></i></span>
                      </div>
                      <div class="media-body">
                    ...
                    <div class="media">
                      <div class="media-left">
                        <span class="avatar avatar-sm avatar-away rounded-circle">
                          <img src="{{asset('assets/dashboard')}}/images/portrait/small/avatar-s-6.png" alt="avatar"><i></i></span>
                      </div>
                      <div class="media-body">
